...
exports.run = async(client, message, args, prefix) => {
    ...
    if (!data || !data.length) return message.channel.send({ embeds: [{ color: "#bee7f7", description: `❌ seems like no one in your guild was cuddled yet :rolling_eyes: once someone is cuddled, it will show here!` }] });
    const emoji = {
        "1": ":crown:",
        "2": ":trident:",
        "3": ":trophy:",
