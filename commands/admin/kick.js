...
exports.run = async(client, message, args) => {
    ...
    if (!message.member.permissions.has('ADMINISTRATOR') && message.member.roles.highest.position <= member.roles.highest.position) return message.reply({ embeds: [{ color: "RED", description: 'you cannot kick someone with a higher or equal role!' }] });
