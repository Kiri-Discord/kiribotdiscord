...
exports.run = async (client, message, args) => {
    ...
    if (!message.member.hasPermission('KICK_MEMBERS')) return message.channel.send('You do not have \`Ban Members\` permission to use this command 😔').then(m => m.delete({timeout: 5000}));
