...
exports.run = async (client, message, args) => {
    ...
    if (target.id === client.user.id) return message.inlineReply(`on this day, i vow to be completely yours forever, ${message.author.username}.`)
    if (target.bot) return message.inlineReply("you can't kiss that bot, sorry :(")
