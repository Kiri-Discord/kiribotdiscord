...
exports.run = async (client, message, args, prefix) => {
	...
	.setColor("#bee7f7")
	.setAuthor('step 1 of 5', 'https://i.stack.imgur.com/kOnzy.gif')
	...
	while(!duration) {
		if (!ongoing) {
			embed
			.setAuthor('step 2 of 5', 'https://i.stack.imgur.com/kOnzy.gif')
	...
	while(!winners) {
		if (!ongoing) {
			embed
			.setAuthor('step 3 of 5', 'https://i.stack.imgur.com/kOnzy.gif')
	...
	while(!pingRole) {
		if (!ongoing) {
			embed
			.setAuthor('step 4 of 5 (optional)', 'https://i.stack.imgur.com/kOnzy.gif')
	...
	while(!prize) {
		embed
		.setAuthor('step 5 of 5', 'https://i.stack.imgur.com/kOnzy.gif')
