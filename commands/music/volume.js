...
exports.run = async(client, message, args) => {
    ...
    if (Number(args[0]) > 100 || Number(args[0]) < 0) return message.inlineReply({ embed: { color: "f3f3f3", description: `the amount of the volume must not lower than zero, and must not higher than 100% ❌` } });
    queue.volume = args[0];
