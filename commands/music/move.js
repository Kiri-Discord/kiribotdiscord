...
exports.run = async (client, message, args) => {
    ...
    if (!args[0]) return message.channel.send({embed: {color: "f3f3f3", description: `you must to tell me what song you want to move! use \`${setting.prefix}help move\` to learn more :wink:`}});
    if (!args[1]) return message.channel.send({embed: {color: "f3f3f3", description: `where do you want to move that song to? use \`${setting.prefix}help move\` to learn more :wink:`}});
