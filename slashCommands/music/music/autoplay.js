...
exports.run = async(client, interaction) => {
    ...
    if (queue.karaoke.isEnabled) return interaction.reply({ embeds: [{ color: "#bee7f7", description: `autoplay is not possible when scrolling lyrics is on :pensive: you can turn it off by \`/scrolling-lyrics off\`` }], ephemeral: true });
