exports.run = async(client, interaction, db) => {
    ...
    return interaction.editReply({ embeds: [{ color: "#bee7f7", description: `☑️ your goodbye message has been set up!`, footer: { text: `you can test it out using /setgoodbye test!` } }] })
};