...
const offCmd = sync.require('./goodbye/off');
const channelCmd = sync.require('./goodbye/channel');
const contentCmd = sync.require('./goodbye/content');
const testCmd = sync.require('./goodbye/test');
