...
exports.run = async(client, interaction) => {
    ...
    if (!messageId) {
        ...
        if (!onChannel || !onChannel.length) return interaction.reply({
            embeds: [{
                color: 'RED',
                description: `:boom: there isn't any ongoing giveaway on this channel :pensive:\nuse \`/giveaway list\` to get the remaining giveaways on this server, then run this command again with the message ID of that giveaway by \`/giveaway end <message ID>\` :grin:`
            }],
            ephemeral: true
        })
