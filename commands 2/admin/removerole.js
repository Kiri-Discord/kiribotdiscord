...
exports.run = async(client, message, args, prefix) => {
    ...
    if (!alreadyHasRole) return message.reply({ embed: { color: "RED", description: `that user doesn't has that role!` } });
    ...
    try {
        ...
        return message.reply("ouch, i bumped by an error :( can you check the role ID or my perms? that user also might have a higher role than me or the role that you are trying to give that user is higher than me.");
    }
