...
exports.run = async(client, message, args, prefix) => {
    ...
    try {
        ...
        if (err.status === 404) return message.reply(`you just gave me an invaild country or that country doesn\'t have any cases ${blessEmoji}`)
        return message.reply(`sorry, i got no result. the server might be down tho ${sedEmoji}`)
    }
}
