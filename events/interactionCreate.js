...
module.exports = async(client, interaction) => {
        ...
        try {
            ...
            logger.log('info', `${interaction.user.tag} (${interaction.user.id}) from ${interaction.channel.type === 'DM' ? 'DM' : `${interaction.guild.name} (${interaction.guild.id})`} ran a slash command: /${interaction.commandName} (${new Date(Date.now())})`);
